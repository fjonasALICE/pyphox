...
c**********************************************************************
	subroutine ssy4ro(s,gpt3,gpt4,y3,y4,r,x10,x20,z4,ih1,ih2,
     #	ih4,sy4r)
	implicit real*8 (a-h,l-z)
	parameter (k0max=32)
...
c l'echelle d'energie
	sc = x10*x20*s
	tc = -x20*dsqrt(s)*gpt3*dexp(y4)
	uc = -x10*dsqrt(s)*gpt3*dexp(-y4)
...
c*****************************************************	
	subroutine ssv4o(s,gpt4,gptsup,y3,y4,mf,x10,x20,x4,
     #	ih1,ih2,ih4,sv4)
c integrale a 1 dimensions
	implicit real*8 (a-h,l-z)
	parameter (k0max=32)
...
c*****************************************************	
	subroutine ssy4po(s,gpt3,gpt4,y3,y4,mf,x10,x20,z4,ih1,ih2,
     #	ih4,sy4p)
	implicit real*8 (a-h,l-z)
	parameter (k0max=32)
...
c l'echelle d'energie
	...
	uc = -x10*dsqrt(s)*gpt3*dexp(-y4)
	call strfrao(x1s,ih1,x2s,ih2,x4,ih4,sf)
	call strfrao(x10,ih1,x20,ih2,x40,ih4,sf0)
	call spart45zo(sc,tc,uc,z4,mf,pt4,part45z)
	call spart45zo(sc,tc,uc,un,mf,gpt3,part45z0)
